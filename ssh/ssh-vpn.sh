...
wget -O trial "https://raw.githubusercontent.com/rizood/multiws/main/ssh/trial.sh"
wget -O user-list "https://raw.githubusercontent.com/rizood/multiws/main/ssh/user-list.sh"
wget -O user-lock "https://raw.githubusercontent.com/rizood/multiws/main/ssh/user-lock.sh"
wget -O user-password "https://raw.githubusercontent.com/rizood/multiws/main/ssh/user-password.sh"
wget -O user-unlock "https://raw.githubusercontent.com/rizood/multiws/main/ssh/user-unlock.sh"
chmod +x speedtest
chmod +x xp
chmod +x auto-set
chmod +x add-ssh
