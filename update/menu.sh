...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/GH-reyz/update/main/install_up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/GH-reyz/update/main/version_up)
...
echo -e "$COLOR1│$NC Order ID Cust  : 7117625"
...
echo -e ""
echo -e "  ${COLOR1}[98]${NC} • SET DNS [${YELLOW}Menu${NC}]   ${COLOR1}[99]${NC} • PASSWORD [${YELLOW}Tukar${NC}] $COLOR1 $NC"
if [ "$Isadmin" = "ON" ]; then
echo -e "                                                  $COLOR1│$NC"
ressee="menu-ip"
bottt="menu-bot"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐$NC"
echo -e "$COLOR1│$NC Version     : 🔰 SSH XRAY BY GHREYZ 🔰"
